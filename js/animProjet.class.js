class animProjet{
    ...
    creerInfo(page){
        ...
        switch(this.id){
            case 'projet1' :
                var oArrayImage = [this.arrayImage[0],this.arrayImage[1],this.arrayImage[2]];
                console.log(oArrayImage);
            ...
            break;
            case 'projet2':
                var oArrayImage = [this.arrayImage[3],this.arrayImage[4],this.arrayImage[5]];
            ...
            break;
            case 'projet3':
                var oArrayImage = [this.arrayImage[6],this.arrayImage[7],this.arrayImage[8]];
            ...
            case 'projet4':
                ...
                var oArrayImage = [this.arrayImage[9],this.arrayImage[10],this.arrayImage[11]];
        ...
        oImageGrande.src = oArrayImage[0].src;
        ...
        for(let i = 0;i<3;i++){
            ...
            oArray[i].src = oArrayImage[i].src;
